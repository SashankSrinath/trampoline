...
/* Task resurrect identifier */
#define resurrect_id 0
CONST(TaskType, AUTOMATIC) resurrect = resurrect_id;
...
CONST(tpl_proc_static, OS_CONST) IDLE_TASK_task_stat_desc = {
  ...
  /* entry point (function)   is moved to dynamic descriptor with RESURRECT*/
 ...
 */
/*-----------------------------------------------------------------------------
 * Task resurrect descriptor
 */
#define APP_Task_resurrect_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task resurrect function prototype
 */

FUNC(void, OS_APPL_CODE) resurrect_function(void);
#define APP_Task_resurrect_STOP_SEC_CODE
 ...
 */
/*
 * Task resurrect stack
 */
#define APP_Task_resurrect_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) resurrect_stack_zone[800/sizeof(tpl_stack_word)];
#define APP_Task_resurrect_STOP_SEC_STACK
#include "tpl_memmap.h"

#define resurrect_STACK {resurrect_stack_zone, 800}

/*
 * Task resurrect context
 */
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(struct MSP430X_CONTEXT, OS_VAR) resurrect_int_context;

#define resurrect_CONTEXT &resurrect_int_context
...
/*
 * Static descriptor of task resurrect
 */
CONST(tpl_proc_static, OS_CONST) resurrect_task_stat_desc = {
  /* context                  */  resurrect_CONTEXT,
  /* stack                    */  resurrect_STACK,
  /* entry point (function)   is moved to dynamic descriptor with RESURRECT*/
  /* internal ressource       */  NULL,
  /* task id                  */  resurrect_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task resurrect
 */
VAR(tpl_proc, OS_VAR) resurrect_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
