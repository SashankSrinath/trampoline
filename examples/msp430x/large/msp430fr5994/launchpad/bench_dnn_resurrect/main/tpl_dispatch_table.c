 ...
 *
 * Dispatch table for application base
...
/* os services */
    ...
    (tpl_system_call) tpl_terminate_step_resurrect_service,
    (tpl_system_call) tpl_release_resource_service,
    (tpl_system_call) tpl_schedule_service,
    (tpl_system_call) tpl_hibernate_os_service,
    (tpl_system_call) tpl_shutdown_os_service,
    (tpl_system_call) tpl_restart_os_service,
    (tpl_system_call) tpl_chain_task_service,
    (tpl_system_call) tpl_start_os_resurrect_service,
