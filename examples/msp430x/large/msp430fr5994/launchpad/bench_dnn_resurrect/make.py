...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application base
...
try:
 ...
 print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file main.oil.")
 print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
 print("goil -t=msp430x/large/msp430fr5994/launchpad --templates= main.oil")
 sys.exit(1)
...
oilCompiler = "goil"
oilFlags = ["-t=msp430x/large/msp430fr5994/launchpad"]
...
#--- Add generated files
sourceList.append("main/tpl_app_config.c")

sourceList.append("main/tpl_dispatch_table.c")
sourceList.append("main/tpl_invoque.S")
sourceList.append("main/tpl_irq_handlers.S")
sourceList.append("main/tpl_resurrect.c")
