...
sys.path.append("/home/sashank/resurrect_predict/trampoline/make")
...
with_com = False
scheduler = "osek"
trampoline_base_path = "/home/sashank/resurrect_predict/trampoline/"
cflags = []
cppflags = []
ldflags = []
asflags = []
...
includeDirs += ["-I","/home/sashank/resurrect_predict/trampoline/machines/msp430x/large"]
includeDirs += ["-I","/home/sashank/resurrect_predict/trampoline/machines/msp430x/large/msp430fr5994/launchpad/checkpointing"]
if with_ioc:
  includeDirs += ["-I", "/home/sashank/resurrect_predict/trampoline/ioc"]
includeDirs += ["-I", "/home/sashank/resurrect_predict/trampoline/os"]
includeDirs += ["-I", "/home/sashank/resurrect_predict/trampoline/debug"]
includeDirs += ["-I", "main"]
cflags   += includeDirs
...
postVariableMapping = dict(
  MACHINE_PATH='/home/sashank/resurrect_predict/trampoline/machines',
  ARCH_PATH='/home/sashank/resurrect_predict/trampoline/machines/msp430x',
  BOARD_PATH='/home/sashank/resurrect_predict/trampoline/machines/msp430x/large/msp430fr5994/launchpad',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("DSLite") != None:
      print("\033[1m\033[95mFlashing main_exe on msp430x/large/msp430fr5994/launchpad\033[0m")
